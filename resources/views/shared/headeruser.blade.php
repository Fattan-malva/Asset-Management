    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbarMenu" class="navbar collapse d-md-flex">
            <ul class="navbar-nav d-flex flex-row">
                <li class="nav-item"><a href="{{ route('shared.homeUser') }}"
                        class="nav-link {{ Request::is('home/user') ? 'active' : '' }}">Home</a></li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="configDropdown">
                        <li><a class="dropdown-item {{ Request::is('customer.index') ? 'active' : '' }}"
                                href="{{ route('customer.index') }}">Profile</a></li>
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link {{ Request::is('home') ? 'active' : '' }}"
                        href="{{ route('shared.home') }}">Home</a></li>
                <li class="nav-item"><a class="nav-link {{ Request::is('home') ? 'active' : '' }}"
                        href="{{ route('customer.index') }}">Profile</a></li>
