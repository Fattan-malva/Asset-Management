            ...
            <ul class="navbar-nav d-flex flex-row">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="activityDropdown">
                        <li><a class="dropdown-item {{ Request::is('assets.index') ? 'active' : '' }}"
                                href="{{ route('assets.index') }}">Operation</a></li>
                        <li><a class="dropdown-item {{ Request::is('assets.history') ? 'active' : '' }}"
                                href="{{ route('assets.history') }}">History</a></li>
                    </ul>
                </li>
...
.navbar a {
    ...
    display: inline-block; /* Ensures the link is block-level */
}
...
.navbar a:focus,
.navbar a:active {
    color: #515d6a; /* Change text color on hover and active */
